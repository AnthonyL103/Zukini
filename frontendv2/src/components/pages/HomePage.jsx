  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 max-w-xl w-full px-4">
        ...
        <section className="backdrop-blur-md bg-white/20 rounded-2xl shadow-xl p-10 text-center my-8">
          <h2 className="text-3xl font-semibold text-[#67d7cc] mb-6">Ready to Start?</h2>
          <button
            onClick={() => navigate('/create')}
            className="px-10 py-4 bg-primary text-white rounded-xl hover:bg-primary-hover transition transform hover:scale-105 active:translate-y-1 hover:cursor-pointer"
          >
            Upload Your Notes
          </button>
        </section>
        ...
        <section className="py-16 bg-white">
          ...
          <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white p-8 rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 text-center group hover:-translate-y-2"
              >
                <div className="h-20 w-20 mx-auto mb-6 bg-gradient-to-br from-primary/10 to-primary/20 rounded-2xl flex items-center justify-center transition-colors duration-300 group-hover:from-primary/20 group-hover:to-primary/30">
