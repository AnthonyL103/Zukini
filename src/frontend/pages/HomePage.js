...
const Home = () => {
    ...
    return (
        <div className="homecontainer">
            ...
            <p className="homepagecont-body"><strong>Quickstart:</strong></p>

                <p className="homepagecont-body">
                    <strong>2. Upload Your Notes:</strong><br />
                ...
                <div className= "homepagebuttonwrap">  <button className="goback-button" onClick={() => navigate('/files')}>Get Started</button></div>
            ...
            <p className="homepagecont-title">To Save your Notes:</p>
                <p className="homepagecont-body">
                    <strong>1. Create an Account:</strong><br />
                ...
                <p className="homepagecont-body">
                    <strong>6. To Save Your Content:</strong><br />
                ...
                <p className="homepagecont-body">
                    <strong>4. To View Saved Notes:</strong><br />
                    Once you have created an account, log in and you will be able to view all your content that you have saved!
                </p>
                
                <div className= "homepagebuttonwrap">  <button className="goback-button" onClick={() => navigate('/account')}>Login</button></div>
                <div className="gobackwrap" onClick={scrollToNextSlide}>
